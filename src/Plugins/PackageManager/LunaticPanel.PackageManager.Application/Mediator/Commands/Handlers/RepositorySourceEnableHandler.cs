...
internal class RepositorySourceEnableHandler
{
    public async Task Handle(RepositorySourceEnableCommand command, ISourceRepository sourceRepository, CancellationToken ct = default)
    {
        try
        {
